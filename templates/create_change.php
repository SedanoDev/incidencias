    ...
    <div class="detail-main">
        <form action="index.php?page=create_change" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-input" required placeholder="Change summary">
            </div>

            <div class="form-row">
                <div class="form-field">
                    <label for="change_type_id" class="form-label">Change Type</label>
                     <select name="change_type_id" id="change_type_id" class="form-input" required>
                ...
                <div class="form-field">
                    ...
                    <select name="risk_level" id="risk_level" class="form-input">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-input" rows="4" required placeholder="What is being changed?"></textarea>
            </div>

            <div class="form-group">
                <label for="reason_for_change" class="form-label">Reason for Change</label>
                <textarea name="reason_for_change" id="reason_for_change" class="form-input" rows="3" required placeholder="Why is this change needed?"></textarea>
            </div>

            <div class="form-group">
                <label for="backout_plan" class="form-label">Backout Plan</label>
                <textarea name="backout_plan" id="backout_plan" class="form-input" rows="3" required placeholder="How to revert if unsuccessful?"></textarea>
            </div>
