    ...
    <div class="detail-main">
        <form action="index.php?page=create_ci" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="ci_name" id="ci_name" class="form-control" required placeholder="e.g. Server-01">
            </div>

            <div class="form-row">
                <div class="form-field">
                    <label for="ci_type_id" class="form-label">Type</label>
                    <select name="ci_type_id" id="ci_type_id" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" rows="3" placeholder="Specs, location, details..."></textarea>
            </div>
