    ...
    <div class="detail-main">
        <form action="index.php?page=create_problem" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-input" required placeholder="Problem summary">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="root_cause" id="root_cause" class="form-input" rows="3" placeholder="If known..."></textarea>
            </div>
