    ...
    <div class="login-card" style="max-width: 500px;">
        ...
        <form action="index.php?page=register_tenant" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="subdomain" id="subdomain" class="form-input" required placeholder="acme">
            </div>
            <div class="form-group">
                <label for="contact_email" class="form-label">Contact Email</label>
                <input type="email" name="contact_email" id="contact_email" class="form-input" required>
            </div>
            <div class="form-group">
                <label for="admin_username" class="form-label">Admin Username</label>
                <input type="text" name="admin_username" id="admin_username" class="form-input" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="subscription_plan" id="subscription_plan" class="form-input">
